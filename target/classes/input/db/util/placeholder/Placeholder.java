package br.com.meuprojeto.db.util.placeholders;

public class Placeholder
{
	public static final int PLACEHOLDERS_VERSION = 1;
	...
	public Placeholder(int id_cliente,
	...
	/** Metodo tosco que printa todos os campos de um registro Placeholder */
